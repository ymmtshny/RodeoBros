...
var history = function(d) {
	...
	for (var i in d) {
		...
		data += '<li class="items"><a target="_top" href="http://item.rakuten.co.jp/auc-rodeo/' + d[i].number + '" target="_top">';
		data += '<img src="http://thumbnail.image.rakuten.co.jp/@0_mall/auc-rodeo/cabinet/' + d[i].image + '-0.jpg?_ex=250x250"/><br>';
		data += '<h6>' + d[i].name+ '<h6/>';
		data += '<p>' + d[i].brand  + '</p></a>';
		data += '</li>'; 
