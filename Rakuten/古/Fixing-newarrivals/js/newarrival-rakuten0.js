...
var newarrival = function(d) {
  ...
  for (var i in d) {
    ...
    yahoo += '<li><a target="_top" href="http://item.rakuten.co.jp/auc-rodeo/' + d[i].number + '" target="_top">';
    yahoo += '<img src="http://thumbnail.image.rakuten.co.jp/@0_mall/auc-rodeo/cabinet/' + d[i].image + '-0.jpg?_ex=250x250"/><br>';
