...
var newarrival = function(d) {
	...
	var count = 0;
	for (var i in d) {
		global += '<li class="items"><a target="_top" href="http://global.rakuten.com/en/store/auc-rodeo/item/' + d[i].number + '" target="_top">';
		global += '<img src="http://thumbnail.image.rakuten.co.jp/@0_mall/auc-rodeo/cabinet/' + d[i].image + '-0.jpg?_ex=500x500"/><br>';
		global += '<h6>' + d[i].name+ '<h6/></a>';
		global += '<p>' + d[i].brand  + '</p>';
		global += '</li>'; 
...
var history = function(d) {
	var data = ''; 
	var count = 0;
	for (var i in d) {
	 
		data += '<li class="items"><a target="_top" href="http://global.rakuten.com/en/store/auc-rodeo/item/' + d[i].number + '" target="_top">';
		data += '<img src="http://thumbnail.image.rakuten.co.jp/@0_mall/auc-rodeo/cabinet/' + d[i].image + '-0.jpg?_ex=500x500"/><br>';
		data += '<h6>' + d[i].name+ '<h6/></a>';
		data += '<p>' + d[i].brand  + '</p>';
		data += '</li>'; 
