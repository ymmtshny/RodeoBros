...
var newarrival = function(d) {
  var rakuten = ''; 
  for (var i in d) {
    rakuten += '<li><div class="ho">'; 
    rakuten += '<a target="_top" href="http://item.rakuten.co.jp/auc-rodeo/' + d[i].number + '/" target="_top">';
    rakuten += '<img src="http://image.rakuten.co.jp/auc-rodeo/cabinet/' + d[i].image + '-0.jpg" width="190" height="190px" style="padding:15px; background-color:white;" alt="" />';
    rakuten += '<span><p style="margin-top:90px;text-align:center;">' + d[i].brand + '<br />';
	rakuten +=  d[i].name + '</p></span></a></div>';
    rakuten += '</li>'; 
  }
